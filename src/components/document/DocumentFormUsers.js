...
class DocumentFormUsers extends Component {
    ...
    render() {
        ...
        return (
            <div className="DocumentFormUsers">
                <div className="form-group">
                    <label className="control-label">{strings.get('App.documents.documentForm.users.title')}</label>
                    <div>
                        { selectedUsers }
                    </div>
                    <select className="form-control" name="users" value="" onChange={ this.handleAdd }>
                        <option value="" disabled>{strings.get('App.documents.documentForm.users.choose')}</option>
                        { users }
                    </select>
                </div>
            </div>
...
DocumentFormUsers.propTypes = {
    users: React.PropTypes.object.isRequired,
    selected: React.PropTypes.array.isRequired,
    onChange: React.PropTypes.func.isRequired,
}

export default DocumentFormUsers;