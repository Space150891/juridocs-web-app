...
class DocumentFormGroups extends Component {
    ...
    render() {
        ...
        return (
            <div className="DocumentFormGroups">
                <div className="form-group">
                    <label className="control-label">{strings.get('App.documents.documentForm.groups.title')}</label>
                    <div>
                        { selectedGroups }
                    </div>
                    <select className="form-control" name="groups" value="" onChange={ this.handleAdd }>
                        <option value="" disabled>{strings.get('App.documents.documentForm.groups.choose')}</option>
                        { groups }
                    </select>
                </div>
            </div>
...
DocumentFormGroups.propTypes = {
    groups: React.PropTypes.object.isRequired,
    selected: React.PropTypes.array.isRequired,
    onChange: React.PropTypes.func.isRequired,
}

export default DocumentFormGroups;