...
class GlossaryFormSelectors extends Component {
  ...
  tryLoadItems () {
    ...
    } else if (!this.state.tmpItem.name && this.props.currentItem && this.props.currentItem.type === 'selector') {
  ...
  render () {
    let nameLabel = this.hasError('name') ? `${strings.get('App.glossaries.glossaryForm.selectors.name')} ${this.getErrorMessage('name')}` : strings.get('App.glossaries.glossaryForm.selectors.name')
    let descriptionLabel = this.hasError('description') ? `${strings.get('App.glossaries.glossaryForm.selectors.description')} ${this.getErrorMessage('description')}` : strings.get('App.glossaries.glossaryForm.selectors.description')
    let stepLabel = this.hasError('stepId') ? `${strings.get('App.glossaries.glossaryForm.selectors.step')} ${this.getErrorMessage('stepId')}` : strings.get('App.glossaries.glossaryForm.selectors.step')
    let helperTextLabel = this.hasError('helperText') ? `${strings.get('App.glossaries.glossaryForm.selectors.helperText')} ${this.getErrorMessage('helperText')}` : strings.get('App.glossaries.glossaryForm.selectors.helperText')
    let helperLinkLabel = this.hasError('helperLink') ? `${strings.get('App.glossaries.glossaryForm.selectors.helperLink')} ${this.getErrorMessage('helperLink')}` : strings.get('App.glossaries.glossaryForm.selectors.helperLink')
    let isRequiredLabel = this.hasError('isRequired') ? `${strings.get('App.glossaries.glossaryForm.selectors.isRequired')} ${this.getErrorMessage('isRequired')}` : strings.get('App.glossaries.glossaryForm.selectors.isRequired')
      ...
      <FadeModal className="boron-modal form-modal" ref="formModal" onHide={ this.handleFormModalHide }>
        ...
        <div className={ this.getErrorClass('stepId', 'form-group') }>
          ...
          <select className="form-control" name="stepId" value={ this.state.tmpItem.stepId }
                  onChange={ this.handleInputChange }>
            <option value="-1" disabled>{strings.get('App.glossaries.glossaryForm.selectors.choose')}</option>
            { steps }
          </select>
        </div>
        <div className={ this.getErrorClass('helperText', 'form-group') }>
          ...
          {/* <input className="form-control" type="text" name="helperText" value={ this.state.tmpItem.helperText }
                 onChange={ this.handleInputChange }/> */}
          <Editor content={ this.state.tmpItem.helperText } handleChange={ this.handleEditorChange } height={200} />
        </div>
        ...
        <div className="form-actions">
          <button className="btn btn-primary"
                  onClick={ this.handleSaveClick }>{strings.get('App.glossaries.glossaryForm.selectors.save')}</button>
          <button className="btn btn-default"
                  onClick={ this.handleCancelClick }>{strings.get('App.glossaries.glossaryForm.selectors.cancel')}</button>
        </div>
      </FadeModal>
    )
      ...
      <div className="GlossaryFormSelectors form-group">
        ...
        <div className="header">
          <label onClick={ this.handleAccordionToggle }
                 className={ labelClassName }>{strings.get('App.glossaries.glossaryForm.selectors.title')}</label>
        ...
        <div style={divStyle} ref="hidden">
          <SortableList
            ...
            helperClass="SortableItem Selector"
          />
        </div>
      </div>
    )
