...
class GroupFormUsers extends Component {
        ...
        return (
            <div className="GroupFormUsers">
                <div className="form-group">
                    <label className="control-label">{strings.get('App.groupPages.users')}</label>
                    <div>
                        { selectedUsers }
                    </div>
                    <select className="form-control" name="users" value="" onChange={ this.handleAdd }>
                        <option value="" disabled>{strings.get('App.groupPages.choose')}</option>
                        { users }
                    </select>
                </div>
            </div>
...
GroupFormUsers.propTypes = {
    users: React.PropTypes.object.isRequired,
    selected: React.PropTypes.array.isRequired,
    onChange: React.PropTypes.func.isRequired,
}

export default GroupFormUsers;